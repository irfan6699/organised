...
function runafterattach(){
    ...
    function run() {
        ...
        let products = [];
        let allProducts = []; // Full list of products for cart functionality
        let cart = [];
        ...
        const isWeddingPage = window.location.href.includes("wedding.html");
        ...
        const initApp = () => {
            fetch('products.json')
                ...
                .then(data => {
                    allProducts = data; // Store the full list of products
                    if (isWeddingPage) {
                        products = data.slice(16, 32); // Load products 17-32 on wedding.html
                    } else {
                        products = data.slice(0, 16); // Load products 1-16 on index.html
                    }
        ...
        const addCartToHTML = () => {
            ...
            if (cart.length > 0) {
                cart.forEach(item => {
                    ...
                    // Use the full product list (allProducts) to find the product
